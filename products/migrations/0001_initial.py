...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Gallery name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ports', models.CharField(default='N/A', max_length=10, verbose_name='Number of Ports')),
                ...
                ('internalmemory', models.CharField(default='N/A', help_text='Internal Memory', max_length=10, verbose_name='Internal Memory')),
                ('megapixels', models.CharField(default='N/A', help_text='Megapixels', max_length=10, verbose_name='Megapixels')),
                ...
                ('pages', models.CharField(default='N/A', help_text='Number of Pages', max_length=10, verbose_name='Pages')),
                ...
                ('image_3', models.ImageField(upload_to='photo_image_filename')),
                ('image_4', models.ImageField(upload_to='photo_image_filename')),
                ('image_5', models.ImageField(upload_to='photo_image_filename')),
                ('image_6', models.ImageField(upload_to='photo_image_filename')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Category')),
                ('gallery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.Gallery')),
                ('sold_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='users.Profile')),
            ],
            options={
